  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        ...
        <li>Jaya Engineering College, Thiruninravur</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Database and Data Analysis (IBM)</li>
        <li>Visualization and analysis (Accenture)</li>
      </ul>
    ),
  },
];
...
const AboutSection = () => {
  ...
  return (
    <section className="text-white" id="about">
      ...
      <img src="/images/about me.png" width="500" height="500" />
